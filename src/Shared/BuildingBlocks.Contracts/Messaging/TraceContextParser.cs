...
public static class TraceContextParser
{
    ...
    /// </summary>
    /// <param name="traceParent">The <c>traceparent</c> header value, or <see langword="null"/>/empty if the message carries no trace context.</param>
    /// <param name="traceState">The <c>tracestate</c> header value, if any.</param>
    /// <returns>Parsed activity context, or <c>default</c> if <paramref name="traceParent"/> is missing or invalid.</returns>
