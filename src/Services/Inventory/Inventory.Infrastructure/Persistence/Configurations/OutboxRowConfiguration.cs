...
/// <summary>
/// EF Core mapping for <see cref="OutboxRow"/>: table/index configuration supporting the
/// publisher's polling queries (unpublished rows ready to retry, dead-lettered rows, locked rows).
/// </summary>
public sealed class OutboxRowConfiguration : IEntityTypeConfiguration<OutboxRow>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<OutboxRow> entity)
    {
