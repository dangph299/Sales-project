...
public abstract class Specification<T> : ISpecification<T>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="entity"/> satisfies the rule; otherwise <see langword="false"/>.</returns>
    ...
    /// </summary>
    /// <param name="other">Specification to combine.</param>
    /// <returns>A new specification whose expression is the conjunction of both rules.</returns>
