...
public sealed class OrdersController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="command">
    /// The customer and requested lines for the new order.
    /// </param>
    /// <param name="ct">
    /// A token to observe while waiting for the operation to complete.
    /// </param>
    /// <returns>
    /// <c>201 Created</c> with the created order, and an <c>ETag</c> response header set to its version.
    /// </returns>
    [HttpPost]
    ...
    /// </param>
    /// <returns>
    /// <c>200 OK</c> with a page of matching orders.
    /// </returns>
    [HttpGet]
    ...
    /// </param>
    /// <returns>
    /// <c>200 OK</c> with the order, and an <c>ETag</c> response header set to its version.
    /// </returns>
    [HttpGet("{id:guid}")]
    ...
    /// </summary>
    /// <param name="id">
    /// The unique identifier of the order to edit, from the route.
    /// </param>
    /// <param name="body">
    /// The new requested lines.
    /// </param>
    /// <param name="ct">
    /// A token to observe while waiting for the operation to complete.
    /// </param>
    ...
    /// </summary>
    /// <param name="id">
    /// The unique identifier of the order to confirm, from the route.
    /// </param>
    /// <param name="ct">
    /// A token to observe while waiting for the operation to complete.
    /// </param>
    ...
    /// </summary>
    /// <param name="id">
    /// The unique identifier of the order to cancel, from the route.
    /// </param>
    /// <param name="ct">
    /// A token to observe while waiting for the operation to complete.
    /// </param>
