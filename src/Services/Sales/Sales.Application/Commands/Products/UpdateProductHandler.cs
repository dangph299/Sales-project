...
public sealed class UpdateProductHandler(IProductRepository repository, IUnitOfWork unitOfWork, IProductCache cache) : IRequestHandler<UpdateProduct, ProductDto>
{
    ...
    /// </summary>
    /// <param name="request">
    /// The command describing the product to update and its new values.
    /// </param>
    /// <param name="ct">
    /// A token to observe while waiting for the operation to complete.
    /// </param>
    /// <returns>
    /// The updated product, mapped to a <see cref="ProductDto"/>.
    /// </returns>
    /// <exception cref="NotFoundException">
    /// Thrown when no product exists with the given identifier.
    /// </exception>
    /// <exception cref="Sales.Domain.DomainException">
    /// Thrown when the provided name or price is invalid.
    /// </exception>
