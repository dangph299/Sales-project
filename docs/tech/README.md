...
6. [monitoring-demo.md](monitoring-demo.md)
...
- AuditLog: ghi log sự kiện vào MongoDB.
- Shared BuildingBlocks: các thành phần dùng chung như domain base type, CQRS marker, outbox, logging, OpenTelemetry.
